...
data class RecommendationResponse(
	...
	val cafeRecommendation: CafeRecommendation? = null,

	@field:SerializedName("Today's word for you")
	val todaySWordForYou: String? = null,
...
data class CafeRecommendation(
	...
	@field:SerializedName("Unnamed: 21")
	val unnamed21: Any? = null,
	...
	companion object CREATOR : Parcelable.Creator<CafeRecommendation> {
		override fun createFromParcel(parcel: Parcel): CafeRecommendation {
			return CafeRecommendation(parcel)
		}

		override fun newArray(size: Int): Array<CafeRecommendation?> {
