...
class ListCafeAdapter : ListAdapter<CafeDataItem, ListCafeAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    companion object {
        val DIFF_CALLBACK = object : DiffUtil.ItemCallback<CafeDataItem>() {
            override fun areItemsTheSame(oldItem: CafeDataItem, newItem: CafeDataItem): Boolean {
                return oldItem == newItem
            }

            override fun areContentsTheSame(oldItem: CafeDataItem, newItem: CafeDataItem): Boolean {
                return oldItem == newItem
            }
        }
    }
